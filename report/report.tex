...
\fancyfoot[L]{\scriptsize \ttfamily Applied Mathematics in Statistics}
...
\section*{Video Demo Trực Quan}
Toàn bộ video trình bày thuật toán bằng thư viện \textbf{Manim} (Bao gồm giới thiệu nhóm và mô phỏng QR, SVD, Chéo hóa) đã được nhóm biên dịch và đăng tải lên YouTube.

Mời thầy cô xem tại đường dẫn sau: \textbf{\url{https://youtu.be/-fa9aWKXB0Y}}.

\vspace{1cm}

\include{sections/part1}
\include{sections/part2}
\include{sections/phan-3}
